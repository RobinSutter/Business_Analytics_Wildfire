  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { 
            boxShadow: "0 0 20px hsl(var(--fire-red) / 0.6)" 
          },
          "50%": { 
            boxShadow: "0 0 40px hsl(var(--fire-red) / 0.8), 0 0 60px hsl(var(--fire-orange) / 0.4)" 
          },
        },
        "fire-flicker": {
          "0%, 100%": { opacity: "1" },
      ...
      backgroundImage: {
        "gradient-fire": "linear-gradient(135deg, hsl(var(--fire-red)), hsl(var(--fire-orange)), hsl(var(--fire-amber)))",
        "gradient-heat": "linear-gradient(180deg, hsl(var(--fire-red)), hsl(var(--fire-amber)), hsl(var(--fire-yellow)))",
